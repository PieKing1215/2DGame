package me.pieking1215.game.net.packets;
...
public class Packet02Move extends Packet {
    ...
    public Packet02Move(byte[] data) {
        ...
        //Game.debug(DebugLevel.INFO, DebugPriority.DEV, username+" "+movingDir+" "+isMoving);
    }
    ...
    public Packet02Move(int x, int y, int numSteps, boolean isMoving, int movingDir) {
        super(02);
        this.x = x;
        this.y = y;
        this.numSteps = numSteps;
    ...
    @Override
    public void writeDataServer(GameServer server) {
